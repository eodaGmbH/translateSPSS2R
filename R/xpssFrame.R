...
#' @details  \code{x} the input data should be of the format \emph{.csv, .sav or .xlsx}.
#' 
...
#' \tab \code{codepage} \tab atomic numeric \tab ANSI code, which describes the encoding \cr
#' \tab \code{row.names}  \tab atomic numeric or numeric vector \tab row ID's  \cr
#' \tab \code{FILTER} \tab atomic logical or condition \tab Filtercondition or FALSE statement if \code{\link{xpssFilter}} is off\cr
#' \tab \code{TEMPORARY} \tab atomic logical \tab Logical statement if \code{\link{xpssTemporary}} is on or off \cr
#' \tab \code{SPLIT_FILE} \tab atomic logical \tab * will be implemented in the following update \cr
#' \tab \code{DO_IF} \tab atomic logical or condition \tab Do-If-condition or FALSE statement if \code{\link{xpssDoIf}} is off \cr
#' \tab \code{SELECT_IF} \tab atomic logical or condition \tab Select-If-condition or FALSE statement if \code{\link{xpssSelectIf}} is off \cr
...
#'}
#' 
#' The SPSS variables are stored in the variable itself. A variable can have the following attributes: 
